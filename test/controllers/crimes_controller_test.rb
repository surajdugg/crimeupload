...
class CrimesControllerTest < ActionController::TestCase
  ...
  test "should create crime" do
    assert_difference('Crime.count') do
      post :create, crime: { Attachment: @crime.Attachment, Ctime: @crime.Ctime, Description: @crime.Description, Location: @crime.Location, Name: @crime.Name }
    end
  ...
  test "should update crime" do
    patch :update, id: @crime, crime: { Attachment: @crime.Attachment, Ctime: @crime.Ctime, Description: @crime.Description, Location: @crime.Location, Name: @crime.Name }
    assert_redirected_to crime_path(assigns(:crime))
  end
